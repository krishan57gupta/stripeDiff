...
# start=1
# end=100
# # for window size 1MB, means 100 bins
# ft=10
# lt=30
# ntad=5
# bin=1000
# newDir=paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/result_",bin,'_',ft,'-',lt,'-',ntad,'L',sep="")
# if (!file.exists(newDir)){
#   dir.create(newDir)} else{
#     unlink(newDir, recursive = TRUE)
#     dir.create(newDir)}
# generateSimulationData(start, end, newDir)

binList=rep(c(1000,2000,3000,4000,5000),3)
ftList=c(rep(10,5),rep(10,5),rep(10,5))
ltList=c(rep(190,5),rep(190,5),rep(190,5))
ntadList=c(c(10,5,4,3,2),c(10,5,4,3,2)*2,c(10,5,4,3,2)*3)

for(step in 1:15){
  start=1
  end=50
  # for window size 1MB, means 1000 bins
  ft=ftList[step]
  lt=ltList[step]
  ntad=ntadList[step]
  bin=binList[step]
  newDir=paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/Test/result_",bin,'_',ft,'-',lt,'_',ntad,'T',sep="")
  if (!file.exists(newDir)){
    dir.create(newDir)} else{
      unlink(newDir, recursive = TRUE)
      dir.create(newDir)}
...
# start=1
# end=100
# # for window size 2MB, means 400 bins
# ft=10
# lt=70
# ntad=10
# bin=5000
...
# start=1
# end=100
# # for window size 2MB, means 100 bins
# ft=15
# lt=25
# ntad=200/((ft+lt)/2)
# bin=10000
...
# start=1
# end=100
# # for window size 6MB, means 600 bins
# ft=10
# lt=110
# ntad=600/((ft+lt)/2)
# bin=10000
# newDir=paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/result_",bin,'_',ft,'-',lt,'L',sep="")
# if (!file.exists(newDir)){
#   dir.create(newDir)} else{
#     unlink(newDir, recursive = TRUE)
#     dir.create(newDir)}
# generateSimulationData(start, end, newDir)
# 
# # for window size 20MB, means 2000 bins
# ft=10
# lt=190
# ntad=2000/((ft+lt)/2) 
# bin=10000
...
# ntad=600/((ft+lt)/2)
# bin=10000
# newDir=paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/result_",bin,'_',ft,'-',lt,'L',"_",seqD,sep="")
# if (!file.exists(newDir)){
#   dir.create(newDir)} else{
#     unlink(newDir, recursive = TRUE)
#     dir.create(newDir)}
# generateSimulationData(start, end, newDir)
# ########################################## just for checking seq depth
# aa=read.table(paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/result_",bin,'_',ft,'-',lt,'L',"_",seqD,"/simulation",1,"_pair1.txt",sep=""))
# aa=sum(aa)/1000000
# print(aa)
# aa=read.table(paste("~/Desktop/stripeDiff-master/stripeDiff_Krishan/Revision/2_2_181/result_",bin,'_',ft,'-',lt,'L',"_",seqD,"/simulation",1,"_pair2.txt",sep=""))
# aa=sum(aa)/1000000
# print(aa)
# ##########################################
# }
