...
for(depth in depth_list){
  for (pval in c(0.05,0.01,0.001)){
    folder=paste(home,"/1_24/data_Latest_6_varingGeneDiff",depth,"_",tt,"_",pval,sep="")
    ...
    # foreach::foreach(binSize=binSizeListt,.combine=cbind)%dopar%{
      ...
      dataName=paste("A_6_varingGeneDiff_stripe_",type_list[1],"_",type_list[2],"_",pval,sep="")
      ...
      dataName2=paste("A_6_varingGeneDiff_FinalResult_",type_list[1],"_",type_list[2],"_",pval,sep="")
      ...
      pdf(paste(folder,"/","CM_",res,"_",pval,depth,"confusionPlot.pdf",sep=""),height = 10, width = 10)
      ...
      saveRDS(bar_pval_df,paste(folder,"/../confusionPlot_6_varingGeneDiff_HUVEC_IMR90.rds",sep=""))
...
ggsave(filename=paste(folder,"/../","barplot_","confusionPlot_6_varingGeneDiff_HUVEC_IMR90.svg",sep=""),dpi = 300,width=3,height=4)
print(dev.off())
